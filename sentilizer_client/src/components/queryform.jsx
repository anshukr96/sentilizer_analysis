...
class QueryForm extends React.Component {
    ...
    render() {
        ...
        if (this.state.sentiment !== ''){
            response_div = <div className='response-wrappper'>
                           <h3>Sentiment:</h3>
        ...
        return (
            ...
            <div className='query-form-wrapper'>
             <label>Enter text to analyse its sentiment</label>
             <textarea id='sentiment' 
             value={this.state.value}
             onChange={this.handleChange }
             />
             <button type='button' disabled={ this.state.submit_disabled }
